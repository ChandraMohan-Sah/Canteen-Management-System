...
int getcustomers()
{
    ...
    if (!objiff)
    {
        cout << "NO SUCH RECORD AVAILABE !! Press key as mentioned above ..." << endl;
        cin.get();
    }
...
void place_order()
{
    ...
    if (value == 1)
    {
        ...
        cout << "*****************************   INVOICE   ******************************" << endl;
        cout << "------------------------------------------------------------------------" << endl;
        cout << "PR.No." << setw(7) << "NAME" << setw(10) << "Qty" << setw(12) << "Price" << setw(13) << "Amount" << setw(23) << "Amount - discount" << endl
             << endl;
        int yy = 8;
        for (int x = 0; x < c; x++)
        {
        ...
        yy++;
        cout << "		  NET TOTAL        :   "
             << "Rs." << (total + ((ttaxt * total) / 100)) << endl;
        yy++;
        cout << "		  ROUND OFF AMOUNT :   "
             << "Rs." << setprecision(2) << (round(total + ((ttaxt * total) / 100)) - (total + ((ttaxt * total) / 100))) << endl;
        cout << "		  NET AMOUNT DUE   :   "
             << "Rs." << fixed << round(total + ((ttaxt * total) / 100)) << endl
             << endl;
        cout << "-------------------------------------------------------------------------" << endl;
...
void intro()
{
    ...
    system("color 0A");
    Sleep(200);
    cout << " _____             _                   ___  ___                                                  _     _____           _                 " << endl;
    system("color 0B");
    Sleep(200);
    cout << "/  __ \\           | |                  |  \\/  |                                                 | |   /  ___|         | |                " << endl;
    system("color 0C");
    Sleep(200);
    cout << "| /  \\/ __ _ _ __ | |_ ___  ___ _ __   | .  . | __ _ _ __   __ _  __ _  ___ _ __ ___   ___ _ __ | |_  \\ `--. _   _ ___| |_ ___ _ __ ___  " << endl;
    system("color 0D");
    Sleep(200);
    cout << "| |    / _` | '_ \\| __/ _ \\/ _ \\ '_ \\  | |\\/| |/ _` | '_ \\ / _` |/ _` |/ _ \\ '_ ` _ \\ / _ \\ '_ \\| __|  `--. \\ | | / __| __/ _ \\ '_ ` _ \\ " << endl;
    system("color 0E");
    Sleep(200);
    cout << "| \\__/\\ (_| | | | | ||  __/  __/ | | | | |  | | (_| | | | | (_| | (_| |  __/ | | | | |  __/ | | | |_  /\\__/ / |_| \\__ \\ ||  __/ | | | | |" << endl;
    system("color 0F");
    Sleep(200);
    cout << " \\____/\\__,_|_| |_|\\__\\___|\\___|_| |_| \\_|  |_/\\__,_|_| |_|\\__,_|\\__, |\\___|_| |_| |_|\\___|_| |_|\\__| \\____/ \\__, |___/\\__\\___|_| |_| |_|" << endl;
    system("color 04");
    Sleep(200);
    cout << "                                                                  __/ |                                       __/ |                      " << endl;
    system("color 07");
    ...
    system("color 0c");
    Sleep(200);
    cout << " | |     _ __ ___  __ _| |_ ___  __| | | |__  _   _ " << endl;
    system("color 0d");
    Sleep(200);
    cout << " | |    | '__/ _ \\/ _` | __/ _ \\/ _` | | '_ \\| | | |" << endl;
    system("color 0d");
    Sleep(200);
    cout << " | |____| | |  __/ (_| | ||  __/ (_| | | |_) | |_| |" << endl;
    system("color 0e");
    Sleep(200);
    cout << "  \\_____|_|  \\___|\\__,_|\\__\\___|\\__,_| |_.__/ \\__, |" << endl;
    system("color 0e");
    Sleep(200);
    cout << "                                               __/ |" << endl;
    system("color 07");
    ...
    cout << "                               |A A Y U S H  P A T H A K            |" << endl;
    cout << "                               |B I K A S H  P A N D E Y            |" << endl;
    cout << "                               |B I S H A L  G I R I                |" << endl;
    cout << "                               |C H A N D R A  M O H A N  S H A H   |" << endl;
    cout << "                               |____________________________________|" << endl<<endl;
	
	cout << " 	                	 P R E S S    E N T E R "         << endl;
    cin.get();
}
...
void customer_menu()
{
    ...
    cout << "2.DELETE CUSTOMERS RECORDS" << endl;
    cout << "3.BACK TO ADMINISTRATOR MODE" << endl;
...
{	
    ...
    cout << "3.MODIFY PRODUCTS" << endl;
    cout << "4.DELETE PRODUCTS" << endl;
    cout << "5.BACK TO ADMINISTRATOR MODE" << endl;
...
{	
    ...
    do
    {
        ...
        cout << "1. VIEW ALL CANTEEN FOOD ITEM" << endl;
        cout << "2. SEE YOUR CUSTOMER ID FOR BILLING" << endl;
...
{	
    ...
    do
    {	
    	cout << "*******************   A D M N I S T R T O R      M O D E   **********************" << endl<<endl<<endl;
        cout << endl;
        cout << "=========================   ADMINISTRATOR ACTIVITIES   =======================" << endl<<endl;
        cout << "1. CUSTOMERS DETAIL" << endl;
        cout << "2. PRODUCTS MENU" << endl;
        cout << "3. INCOME OF THE DAY" << endl;
